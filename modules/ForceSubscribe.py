...
#    Copyright (C) 2020-2021 by @adarshop_xd
...
from Alphasecurity import DRAGONS as SUDO_USERS
from Alphasecurity import pbot
from Alphasecurity.modules.sql import forceSubscribe_sql as sql
        ...
        if (
            ...
            try:
                ...
                try:
                    ...
                    sent_message.edit(
                        "❗ **Alphasecurity is not admin here..**\n__Give me ban permissions and retry.. \n#Ending FSub...__"
                    )
